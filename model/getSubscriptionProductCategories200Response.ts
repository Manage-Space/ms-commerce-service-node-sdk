...
export class GetSubscriptionProductCategories200Response {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<SubscriptionProductCategoryResponse>"
        },
        {
            "name": "success",
            "baseName": "success",
    ...
    static getAttributeTypeMap() {
        return GetSubscriptionProductCategories200Response.attributeTypeMap;
    }
}
